...
class Customer(models.Model):
    ...
    document = models.CharField(max_length=12, unique=True, null=True, blank=True)

    @property         # Can be used to show additional fields in the serializer
...
class Document(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='document_set')
